                ...
                <template slot="items" slot-scope="props">
                  <tr>
                    ...
                    <!-- <td v-for="(k,i) in body" :key="i" class="text-xs-center">
                      {{ props }}
                      {{ get(props.item,k.class) }}
                        <span v-if="k.number">{{ $aid.formatPrice(get(props.item,k.value)) }}</span>
                        <span v-else-if="k.to">
                          <v-btn flat small :to="k.to+get(item,id)">{{ get(props.item,k.value) }}</v-btn>
                        </span>
                        ...
                        <span v-else>
                          <span v-if="k.type == 'number'">{{ $aid.formatPrice(get(props.item,k.value)) }}</span>
                          <span v-else-if="(k.type == 'date')">{{ get(props.item,k.value) | moment(k.format) }}</span>
